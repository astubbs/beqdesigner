...
def _build_validation_data(
    ...
    from auto_beq._auto_beq_helpers import STRATEGY_WELCH, cached_extract_features_with_strategy
...
def test_baseline_determinism(tmp_path, caplog):
    ...
    from auto_beq._auto_beq_helpers import discover_wav_catalogue_pairs_cached
...
def test_f5_cross_episode_consistency(tmp_path, caplog):
    ...
    from auto_beq._auto_beq_helpers import STRATEGY_WELCH, discover_wav_catalogue_pairs_cached
