...
BESSEL_6DB_F_MULTIPLIER = {
    1: [0.5791803096274168],
    2: [0.8778964030526298],
    3: [0.9593708669362357, 1.0499940379290258],
    4: [1.1762062947693392, 1.0491588896742203],
    5: [1.0986977150653694, 1.2837706606275692, 1.1382124121364952],
    6: [1.3838694024703282, 1.22726882912893, 1.165330884388839],
    7: [1.2168842542013958, 1.4806698656248503, 1.3166189921499751, 1.239994124389672],
    8: [1.5750364479961727, 1.4055455943386979, 1.3183981544811527, 1.2798076769468012],
    9: [1.332492533504713, 1.6667508846376589, 1.493118583196451, 1.397993669568133, 1.3481411871372762],
    10: [1.755568189140181, 1.5787136331192284, 1.4773140908919233, 1.4188190440315802, 1.3917050200650205],
    11: [1.4427366298663766, 1.8414509875253982, 1.6620551701628803, 1.5555913649201683, 1.4902162491324333, 1.4542519004427972],
    12: [1.9245077064963008, 1.7430879097091418, 1.6324566028414762, 1.5614567582268655, 1.5184057552113275, 1.497972762013299],
    13: [1.5466477081096877, 2.004909170679091, 1.8218656248682707, 1.7077519796216425, 1.6320598462469038, 1.5831793725944932, 1.5555841431852053],
    14: [2.082841404774629, 1.8984887500174514, 1.781429115681775, 1.7017599747796337, 1.6479845121513308, 1.6144790662886725, 1.5983530206550363],
    15: [1.644709080010549, 2.1584851157045954, 1.9730742301744453, 1.8534968652258987, 1.7704136062787548, 1.712460821476911, 1.6739757768053445, 1.6519069252404444],
    16: [2.2320081647049776, 2.0457415953597127, 1.92399414356433, 1.8379490042023066, 1.7763846097231364, 1.7336345963144038, 1.7065496542640022, 1.6933963318083451],
    17: [1.7376314451960622, 2.30356355513161, 2.1166066238216232, 1.9929752577298545, 1.9043378559131023, 1.8396173335516892, 1.7931657437573931, 1.761776037153633, 1.7435909370081666],
    18: [2.3732896408573327, 2.185778581410785, 2.060501710021839, 1.9695784998780625, 1.9020751391312667, 1.852375663675232, 1.81724180869496, 1.794733746002243, 1.7837360574025898],
    19: [1.8260672464944971, 2.441311177873279, 2.253359198805611, 2.126637510174036, 2.0336857174475713, 1.9637099535609805, 1.9111346558943285, 1.8727078459250435, 1.8464356623976337, 1.8311055534887362],
    20: [2.5077406392319244, 2.3194425137702126, 2.1914464705815444, 2.0966843138616467, 2.0244976909955867, 1.9693555007230827, 1.9280083123861391, 1.8984156858854926, 1.8793181601515137, 1.8699392336492326],
    21: [1.9105778103815463, 2.5726795473296846, 2.3841151264318796, 2.2549907210622813, 2.158604999615166, 2.084429787290062, 2.0269833541562936, 1.9830199317729105, 1.9504803835273017, 1.9280611460146488, 1.9148885891698997],
    22: [2.636219719832998, 2.4474566742844424, 2.3173298268651585, 2.2194815562536405, 2.143509879786458, 2.0839800584280064, 2.037660620797812, 2.002489043377571, 1.9770857536067714, 1.960620049762742, 1.9524878485387445],
    23: [1.991213965676138, 2.698444394595009, 2.509540374213987, 2.378520239378114, 2.279350353955975, 2.2017446442563973, 2.1403317635589616, 2.0918671670441906, 2.0543051363016365, 2.026340754440461, 2.0066302613275306, 1.9956815130222518],
    24: [2.759429226238894, 2.5704335426831606, 2.43861555245003, 2.338246542464876, 2.2591510936805563, 2.19602771024758, 2.145570410838636, 2.105992792944637, 2.0752825058836324, 2.0535564129807673, 2.038719132638274, 2.0318787753114305],
    25: [2.067915056160181, 2.8192431575792, 2.630198167786314, 2.4976662253952466, 2.396204066691355, 2.315755019406957, 2.2510452101917946, 2.1987695241299927, 2.1574768808220797, 2.1238223205478177, 2.101217357927922, 2.081423548044805, 2.0744464575409776],
}
...
class FilterType(Enum):
    ...
    BESSEL_MAG3 = ('BESM3', 'Bessel -3dB')
    BESSEL_MAG6 = ('BESM6', 'Bessel -6dB')
...
class CompoundPassFilter(ComplexFilter):
    ...
    def calculate_biquads(self, fs) -> List[Biquad]:
        ...
        elif self.type is FilterType.BESSEL_MAG3 or self.type is FilterType.BESSEL_MAG6:
            q = BESSEL_Q_FACTOR[self.order]
            f_mult = BESSEL_3DB_F_MULTIPLIER[self.order] if self.type is FilterType.BESSEL_MAG3 else BESSEL_6DB_F_MULTIPLIER[self.order]
            if len(q) != len(f_mult):
                raise ValueError(f"Invalid Bessel mag parameters for {self.order} - {q} - {f_mult}")
            return [self.__calculate_bessel_filter(fs, q[i], f_mult[i]) for i in range(len(q))]
        else:
