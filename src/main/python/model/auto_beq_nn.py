...
# ---------------------------------------------------------------------------
# Backward-compat re-exports — classes moved to auto_beq_advisor.py
# ---------------------------------------------------------------------------

from model.auto_beq_advisor import TrainedModelAdvisor, LateFusionAdvisor  # noqa: F401,E402
