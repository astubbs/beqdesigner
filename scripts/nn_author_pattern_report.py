...
Usage::
    ...
    poetry run python3 scripts/nn_author_pattern_report.py
    poetry run python3 scripts/nn_author_pattern_report.py -o docs/author_patterns.md
"""
...
def generate_report(catalogue_path: Path, output=None) -> None:
    ...
    pr("---")
    pr("Generated by `scripts/nn_author_pattern_report.py`")
