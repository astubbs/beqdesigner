...
# BEQ_AUTO_YES is set in the Dockerfile (default on). The prompt still
# prints what's happening but auto-answers. Use --no-yes on the CLI to
# override and prompt interactively.
